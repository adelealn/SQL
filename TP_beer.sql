...
SELECT ticket.ANNEE, ticket.NUMERO_TICKET, ticket.DATE_VENTE, SUM(QUANTITE) as TOTAL FROM ticket INNER JOIN ventes ON ticket.NUMERO_TICKET=ventes.NUMERO_TICKET AND ticket.ANNEE=ventes.ANNEE GROUP BY ticket.NUMERO_TICKET HAVING TOTAL>500;
