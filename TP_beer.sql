...
#Q28
#Donner l’ID, le nom, le volume et les quantités vendues en 2015 et 2016, des bières 
...
#INNER JOIN (SELECT SUM(QUANTITE) FROM ventes WHERE ANNEE = 2016 GROUP BY ID_ARTICLE) AS SOMME_2016
#INNER JOIN (SELECT SUM(QUANTITE) FROM ventes WHERE ANNEE = 2015 GROUP BY ID_ARTICLE) AS SOMME_2015 
